...
const AppContent = () => {
    ...
    const topBarActions = me ? (_jsxs(_Fragment, { children: [me.role && (_jsx(Badge, { variant: me.role === 'admin' ? 'primary' : 'default', size: "sm", children: me.role.toUpperCase() })), _jsxs("div", { className: "flex items-center gap-2 rounded-lg glass px-2 py-1.5 max-w-[10.5rem] lg:max-w-[12rem]", children: [_jsx("span", { className: "inline-flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-primary-400 to-primary-600 text-[11px] font-semibold text-white", children: initials }), _jsxs("div", { className: "leading-tight min-w-0", children: [_jsx("p", { className: "truncate text-xs font-semibold text-text-primary", children: me.login }), _jsx("p", { className: "hidden text-[10px] text-text-secondary xl:block", children: "Account" })] })] })] })) : null;
    const sidebarFooter = me ? (_jsxs("div", { className: "space-y-2 text-xs", children: [_jsx("p", { className: "font-semibold text-text-primary", children: "Auth Session" }), _jsxs("div", { className: "flex items-center justify-between text-text-secondary", children: [_jsx("span", { children: "User" }), _jsx("span", { className: "truncate pl-2 text-text-primary", children: me.login })] }), _jsxs("div", { className: "flex items-center justify-between text-text-secondary", children: [_jsx("span", { children: "Role" }), _jsx("span", { className: "text-text-primary uppercase", children: me.role })] })] })) : null;
    if (isMeLoading) {
