...
const JobsPage = () => {
    ...
    const openCreateJobPrompt = () => {
        ...
        runJob({ repo, prNumber, headSha, installationId }, {
            onError: () => {
